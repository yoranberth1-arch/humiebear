/* =========================================================
   ...
   Keeps the original site interactions and restores the edition cards.
========================================================= */
...
(() => {
  ...
  /* Restore the four large selectable edition cards used in the form. */
  const editionContainer = document.querySelector(".edition-options");
  if (editionContainer) {
    editionContainer.innerHTML = `
      ...
      <label class="edition-option">
        ...
        <span>
          ...
          <small>Vanaf 20 personen · 2 uur · prijs op maat · €150 opstart 20–49 · vanaf 50 geen opstart</small>
        </span>
      </label>
    `;
  }
  ...
  /* Load the original interaction script after the edition cards exist. */
  const script = document.createElement("script");
  script.src = `${LEGACY_SCRIPT}?v=restore-edition-cards-20260918`;
  script.defer = false;
